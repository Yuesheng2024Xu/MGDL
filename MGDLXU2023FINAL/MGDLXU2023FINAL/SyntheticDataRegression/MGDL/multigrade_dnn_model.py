...
def multigrade_dnn_model(data, nn_parameter, opt_parameter, trained_variable):
    ...
    for i in range(1,  grade_length + 1):
        ...
        if i==1:
            trained_variable, prev_info = m_dnn.multigrade_dnn_model_grade_1(trained_variable, data, layers_dims, opt_parameter, 
                                                                             max_learning_rate, min_learning_rate, epochs, activation)
        else:           
            trained_variable, prev_info = m_dnn.multigrade_dnn_model_grade_ell(trained_variable, data, prev_info, layers_dims, opt_parameter, 
                                                                               max_learning_rate, min_learning_rate, epochs, activation)
